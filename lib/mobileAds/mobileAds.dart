...
class _mobileAdsState extends State<mobileAds> {
  final adUnitId = 'ca-app-pub-1895475762491539/7952169297';
  BannerAd? _bannerAd;
  ...
  Widget build(BuildContext context) {
    return _bannerAd != null ? Align(
      ...
      child: falhouAoCarregar == false ? SafeArea(
        ...
        child: Text(
          'Anuncio não carregado!\nIsso se dá se caso estiver usando um ADBlocker, por favor evite usar AdBlocker enquanto usa o QR Code Generator! Caso não esteja usando ignore essa mensagem!',
          style: TextStyle(
